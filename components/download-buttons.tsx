...
export default function DownloadButtons({ size = "md", disabled = true, className = "" }: DownloadButtonsProps) {
  ...
  const handleAppStoreClick = () => {
    if (!disabled) {
      window.open("https://apps.apple.com/app/saveapp", "_blank", "noopener,noreferrer")
    }
  }

  const handlePlayStoreClick = () => {
    if (!disabled) {
      window.open("https://play.google.com/store/apps/details?id=com.saveapp", "_blank", "noopener,noreferrer")
    }
  }

  return (
    <div className={`download-buttons-wrapper ${className}`}>
      <button
